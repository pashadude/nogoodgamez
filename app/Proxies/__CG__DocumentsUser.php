...
class User extends \Documents\User implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Documents\\User' . "\0" . 'id', '' . "\0" . 'Documents\\User' . "\0" . 'real', '' . "\0" . 'Documents\\User' . "\0" . 'session');
        }
    ...
    public function setReal($real)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReal', array($real));

        return parent::setReal($real);
    }
    ...
    public function getReal()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReal', array());
